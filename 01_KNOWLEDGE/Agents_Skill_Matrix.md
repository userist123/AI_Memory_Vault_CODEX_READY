...
| 8 | `secops_auditor` 🛡️ | Audit de Securitate & Conformitate Guvern | `dfir-operations`, `vault-security-audit`, HG 585/2002, EUCI, NATO |
| 9 | `threat_hunting_analyst` 🔍 | Threat Hunting, YARA, Sigma & DFIR | Regulament YARA/Sigma offline, EVTX analysis, Containment |
| 10 | `wpf_engineer` 🖥️ | Dezvoltare C# WPF .NET 10 Enterprise | `ui-tokens` (Obsidian Tactical), MVVM, Async I/O |
| 11 | `web_creative_developer` 🌟 | Creative Coding, 3D WebGL & Awwwards (88 Skills) | Three.js, Shaders, GSAP, Lenis, CobeJS, VantaJS, MatterJS |
| 12 | `ui_ux_designer` 🎨 | UI/UX Design & Prompting (11 Skills) | `design-first-ui-prompting`, `aura-asset-images`, `unsplash-asset-images` |
| 13 | `frontend_saas_engineer` 🌐 | Frontend SaaS (Next.js App Router, Tailwind) | `optimize-web-animations`, `publish-project-to-github`, Zero-Dollar Stack |
| 14 | `game_engineer` 🎮 | Game Engine 3D / WebGL / ARPG (21 Skills) | Combat, Level Authoring, Map Editor, Fog of War, VFX, Audio |
| 15 | `quant_developer` 📈 | Trading Algoritmic & Risk Veto (Python) | 5 Module (data/strategy/risk/execution/journal), Anti-Lookahead |
| 16 | `local_ai_engineer` 🤖 | AI Local (Ollama, JSON Mode Verification) | Structured JSON output, Pydantic schema validation, Fallbacks |
| 17 | `content_strategist` ✍️ | Copywriting & Generare Voice (4 Skills) | `write-like-meng-on-x`, `x-bookmark-quote-posts`, `elevenlabs-tts` |
| 18 | `agentic_workflow_orchestrator` 🔄 | Orchestrator Reflexion & Tree-of-Thought | Ciclul OODA, Tree-of-Thought, SelfRefine critique, Prevenție erori |
