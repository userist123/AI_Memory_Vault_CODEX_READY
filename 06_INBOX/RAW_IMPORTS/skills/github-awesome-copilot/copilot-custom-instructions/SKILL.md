...
description: Ghid de instrucțiuni custom (Copilot / Antigravity / Claude Code) pentru standarde de cod per fișier/stack.
---

# Copilot Custom Instructions & Prompt Rules
