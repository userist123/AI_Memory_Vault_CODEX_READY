/**
 * @alpha
 * Structured logger contract for the admin BFF adapter.
 *
 ...
 */
export interface IAdminBffLogger {
...
/**
 * @alpha
 * Configuration for creating an admin BFF logger.
 */
export interface IAdminBffLoggerConfig {
