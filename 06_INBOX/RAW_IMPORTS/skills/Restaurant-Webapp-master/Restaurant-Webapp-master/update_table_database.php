<?php
	...
	{
		$output = "";
		$tableNameUpdate = mysqli_real_escape_string($connect, $_POST['tableNameUpdate']);
		$capacityUpdate = mysqli_real_escape_string($connect, $_POST['capacityUpdate']);
		$availabilityUpdate = $_POST['availabilityUpdate'];
		$statusUpdate = $_POST['statusUpdate'];
		$table_id = $_POST['table_id'];

		$query = "UPDATE book_table SET table_name = '$tableNameUpdate', capacity = '$capacityUpdate', availability = '$availabilityUpdate', status = '$statusUpdate' WHERE id = '" . $table_id . "'";
