<?php
	...
	{
		$output = "";
		$storeName = mysqli_real_escape_string($connect, $_POST['store-name']);
		$status = $_POST['status'];

		/*
		if($_POST['store_id'] != '')
		{
			$query = "UPDATE store SET store_name = '$storeName', status = '$status' WHERE id = '" . $_POST['store_id'] . "'";
			$message = "Data Updated Successfully!!!";
		}
		else
		{
		*/
			$query = "INSERT INTO store(store_name, status) VALUES('$storeName', '$status')";
