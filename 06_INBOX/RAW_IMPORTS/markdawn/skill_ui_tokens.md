# Skill: UI Tokens Obsidian Tactical
# Locație: .agents/skills/ui-tokens/skill.md (Google Antigravity)

## Când se activează

Orice task care implică fișiere `.xaml`, `Theme/*.xaml`, `Styles/*.xaml` sau `ControlTemplate`.
