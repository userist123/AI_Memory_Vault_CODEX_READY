# CEI 19 PUNCTE PROCENTUALE: REALITATE SAU ARTEFACT? (`NINETEEN_PERCENTAGE_POINTS_FINDINGS.md`)
...
| Interval Preț | Piețe ($N$) | Victorii ($k$) | Rata de Câștig ($\hat{p}$) | Preț Mediu ($ar{p}$) | Ecart ($\hat{p} - ar{p}$) | Interval Wilson 95% |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
