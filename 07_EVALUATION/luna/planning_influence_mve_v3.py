...
def compile_memory_v3(
    ...
    # V1 Uncertainty Policy and V2 Verification Action
    ...
    # Confirmed contradiction or NOT_APPLICABLE acts as a safety veto
...
def run_planner_v3(
    ...
    *,
    ...
    if policy == "v2_verification_action" and mem_state.verification_required:
