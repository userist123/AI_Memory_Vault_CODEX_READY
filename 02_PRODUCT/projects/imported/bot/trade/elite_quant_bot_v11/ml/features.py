...
NOTE: FEATURE_DIM bump invalidates older saved weights. ml.store.MLStore
resets weights automatically when stored dim != current dim.
"""
...
def build_features(rates_h1, rates_m15, tick, info) -> List[float]:
