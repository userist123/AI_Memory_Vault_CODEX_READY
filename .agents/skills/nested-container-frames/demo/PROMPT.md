# Nested Container Frames Demo Prompts

## Minimal prompt

Use $nested-container-frames to create a responsive standalone HTML design with the same visual confidence, hierarchy, and interaction finish as the included Neuform reference.

## Recreate the demo

Use $nested-container-frames to recreate the design quality and behavior of **Squish — Turn Your Ideas Into Stunning Visuals** as a complete responsive HTML document. Treat the included demo/index.html as the visual and interaction reference, not as a loose mood board.
