# Optimize Web Animations Demo Prompts

## Minimal prompt

Use $optimize-web-animations to create a polished standalone HTML example that clearly demonstrates the skill.

## Recreate the demo

Use $optimize-web-animations to build a responsive reference demo for this capability:
...
Use $optimize-web-animations and keep the same implementation contract, but change the subject, copy, palette, and content hierarchy. Preserve the core technique, accessibility behavior, responsive rules, and performance constraints demonstrated by the reference.
