# Editorial Tech Demo Prompts

## Minimal prompt

Use $editorial-tech to create a responsive standalone HTML design with the same visual confidence, hierarchy, and interaction finish as the included Neuform reference.

## Recreate the demo

Use $editorial-tech to recreate the design quality and behavior of **NEUS | Enterprise Brand Architecture** as a complete responsive HTML document. Treat the included demo/index.html as the visual and interaction reference, not as a loose mood board.
