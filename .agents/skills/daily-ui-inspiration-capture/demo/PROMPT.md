# Daily UI Inspiration Capture Demo Prompts

## Minimal prompt

Use $daily-ui-inspiration-capture to create a polished standalone HTML example that clearly demonstrates the skill.

## Recreate the demo

Use $daily-ui-inspiration-capture to build a responsive reference demo for this capability:
