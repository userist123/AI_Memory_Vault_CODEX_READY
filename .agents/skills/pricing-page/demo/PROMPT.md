# Pricing Page Demo Prompts

## Minimal prompt

Use $pricing-page to create a polished standalone HTML example that clearly demonstrates the skill.

## Recreate the demo

Use $pricing-page to build a responsive reference demo for this capability:
...
Use a three-plan conversion layout with one clearly recommended plan.
...
Use $pricing-page and keep the same implementation contract, but change the subject, copy, palette, and content hierarchy. Preserve the core technique, accessibility behavior, responsive rules, and performance constraints demonstrated by the reference.
