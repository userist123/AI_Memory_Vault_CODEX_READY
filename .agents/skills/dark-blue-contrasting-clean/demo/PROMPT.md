# Dark Blue Contrasting Clean Demo Prompts

## Minimal prompt

Use $dark-blue-contrasting-clean to create a polished standalone HTML example that clearly demonstrates the skill.

## Recreate the demo

Use $dark-blue-contrasting-clean to build a responsive reference demo for this capability:
...
- Use Dark Blue Contrasting Clean as the central system title.
...
Use $dark-blue-contrasting-clean and keep the same implementation contract, but change the subject, copy, palette, and content hierarchy. Preserve the core technique, accessibility behavior, responsive rules, and performance constraints demonstrated by the reference.
