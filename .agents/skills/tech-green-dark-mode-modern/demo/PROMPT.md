# Tech Green Dark Mode Modern Demo Prompts

## Minimal prompt

Use $tech-green-dark-mode-modern to create a polished standalone HTML example that clearly demonstrates the skill.

## Recreate the demo

Use $tech-green-dark-mode-modern to build a responsive reference demo for this capability:
...
- Use Tech Green Dark Mode Modern as the central system title.
...
Use $tech-green-dark-mode-modern and keep the same implementation contract, but change the subject, copy, palette, and content hierarchy. Preserve the core technique, accessibility behavior, responsive rules, and performance constraints demonstrated by the reference.
