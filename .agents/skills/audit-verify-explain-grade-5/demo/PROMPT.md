# Audit Verify Explain Grade 5 Demo Prompts

## Minimal prompt

Use $audit-verify-explain-grade-5 to create a polished standalone HTML example that clearly demonstrates the skill.

## Recreate the demo

Use $audit-verify-explain-grade-5 to build a responsive reference demo for this capability:
...
Use $audit-verify-explain-grade-5 and keep the same implementation contract, but change the subject, copy, palette, and content hierarchy. Preserve the core technique, accessibility behavior, responsive rules, and performance constraints demonstrated by the reference.
