# Corner Diagonals Demo Prompts

## Minimal prompt

Use $corner-diagonals to create a responsive standalone HTML design with the same visual confidence, hierarchy, and interaction finish as the included Neuform reference.

## Recreate the demo

Use $corner-diagonals to recreate the design quality and behavior of **Auralis - Neural Audio Engine** as a complete responsive HTML document. Treat the included demo/index.html as the visual and interaction reference, not as a loose mood board.
