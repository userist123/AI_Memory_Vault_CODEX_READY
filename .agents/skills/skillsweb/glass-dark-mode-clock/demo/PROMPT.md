# Glass Dark Mode Clock Demo Prompts

## Minimal prompt

Use $glass-dark-mode-clock to create a responsive standalone HTML design with the same visual confidence, hierarchy, and interaction finish as the included Neuform reference.

## Recreate the demo

Use $glass-dark-mode-clock to recreate the design quality and behavior of **Alert Interface** as a complete responsive HTML document. Treat the included demo/index.html as the visual and interaction reference, not as a loose mood board.
