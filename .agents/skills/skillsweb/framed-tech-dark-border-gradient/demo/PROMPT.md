# Framed Tech Dark Border Gradient Demo Prompts

## Minimal prompt

Use $framed-tech-dark-border-gradient to create a polished standalone HTML example that clearly demonstrates the skill.

## Recreate the demo

Use $framed-tech-dark-border-gradient to build a responsive reference demo for this capability:
...
Use $framed-tech-dark-border-gradient and keep the same implementation contract, but change the subject, copy, palette, and content hierarchy. Preserve the core technique, accessibility behavior, responsive rules, and performance constraints demonstrated by the reference.
