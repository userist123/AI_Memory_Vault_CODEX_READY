...
# 🚀 Mapă MOC: Proiecte Active & Proceduri (`02_PRODUCT/projects/` & `10_DOCUMENTATION/procedures/`)

## Proiecte Active (`02_PRODUCT/projects/`)
...
## Proceduri Repetabile (`10_DOCUMENTATION/procedures/`)
