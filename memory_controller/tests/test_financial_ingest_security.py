...
def test_direct_financial_ingest_requires_propose_authorization(monkeypatch):
...
def test_direct_financial_ingest_cannot_select_privileged_lifecycle(monkeypatch):
